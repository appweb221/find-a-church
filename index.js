...
function ChurchAbout() {
    document.body.innerHTML = `<nav class="navbar navbar-expand-lg bg-body-tertiary" id="church-nav">
...
function ChurchPrayer() {
  ...
  </nav><div style="background-color: white; padding: 30px; border-radius: 30px;">    <section class="bottom" style="text-align: center;">
<fieldset>
...
function ChurchSignin() {
  ...
  </nav><div style="background-color: white; padding: 30px; border-radius: 30px;"><label for="uname"><b>Username:</b></label>
<br>
...
function ChurchSignup() {
  ...
  </nav><div style="background-color: white; padding: 30px; border-radius: 30px;"><form style="text-align: center"><fieldset>
...
function FindNearestChurch() {
  ...
  </nav><div style="background-color: white; padding: 30px; border-radius: 30px;"><select>
